  ...
  return (
    <section className="form-card">
      ...
      <div className="form-grid">
        ...
        {input.categoryId === 'keikoukan' && <Field label="おおよその本数" name="approximateTubeCount" error={errorMap.approximateTubeCount}><input id="field-approximateTubeCount" type="number" min="1" max="9999" value={String(input.categoryAnswers.approximateTubeCount ?? '')} onChange={(e) => onAnswer('approximateTubeCount', e.target.value === '' ? '' : Number(e.target.value))} /></Field>}
